...
public class MyWrite {
    ...
    final String OPERATOR_NAME = "Write";
    ...
    public void setParameters(File file, String formatName) {
        operator.setParameter("file", file);
        operator.setParameter("formatName", formatName);
    ...
    public Product computeProduct() {
        System.out.println("start write operator...");
        ...
        System.out.println("tiles from write computed successfully!");
