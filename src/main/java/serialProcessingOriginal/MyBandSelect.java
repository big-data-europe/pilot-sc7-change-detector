...
public class MyBandSelect {
	 Operator operator = null;
	    OperatorContext operatorContext;
	    Product targetProduct;
	    final String OPERATOR_NAME = "BandSelect";
	    ...
	    public void setParameters(String[] selectedPolarisations,String[] sourceBandNames) {
	    ...
	    public void setSourceProducts(Product sourceProduct) {
