...
public class Warp {
    ...
    public void computeTile(MyTile targetTile, RenderedImage srcImage) throws OperatorException {
...
//            wimg.mapDestRect(destRect, sourceIndex)
    ...
    RenderedOp createWarpImage(WarpPolynomial warp, final RenderedImage srcImage) {
