        ...
        try {
            ...
            for (int i = 0; i < masterTargetProduct.getNumBands(); i++) {
                ...
                if (band.getClass() == Band.class) {
                    ...
                    bandInfos.put(band.getName(), bandInfo);
                }
            }
        ...
        JavaPairRDD<Tuple2<Point, String>, MyTile> masterRastersCal = masterRastersRdd
                .mapPartitionsToPair((Iterator<Tuple2<String, Point>> iterator) -> {
                    ...
                    for (int i = 0; i < points.size(); i++) {
                        ...
                        if (!bands.containsKey(tuple._1)) {
                            BandInfo info = infos.get(tuple._1);
                            readHDFSTile = new ReadHDFSTile(info.getHdfsPath());
                            bands.put(tuple._1, readHDFSTile);
                        } else {
                            readHDFSTile = bands.get(tuple._1);
                        }
                        ...
                        readHDFSTile.readTile(readTile, bandInfosB.getValue().get(imgMetadataRead.getBandName()));
...
//		JavaPairRDD<Tuple2<Point, String>, MyTile> masterRastersCal = masterRastersRdd
//				.mapToPair((Tuple2<String, Point> tuple) -> {
//					Map<String, ImageMetadata> map = imgMetadataB.getValue();
//					
//					ImageMetadata srcImgMetadataCal1 = imgMetadataB.getValue().get(tuple._1+"_"+"cal1");
//					ImageMetadata trgImgMetadataCal1 = map.get(srcImgMetadataCal1.getBandPairName()+"_"+"cal1");
//					
//					ImageMetadata imgMetadataRead = map.get(srcImgMetadataCal1.getBandPairName()+"_"+"read1");
//					MyTile readTile=new MyTile(imgMetadataRead.getWritableRaster(tuple._2.x, tuple._2.y),
//							trgImgMetadataCal1.getRectangle(tuple._2.x, tuple._2.y),
//							trgImgMetadataCal1.getDataType());
//					ReadHDFSTile readHDFSTile=new ReadHDFSTile();
//					readTile=readHDFSTile.readTile( readTile,bandInfosB.getValue().get(srcImgMetadataCal1.getBandName()));
//					
//					Point targetPoint = tuple._2;
//					CalibrationMetadata calMeatadata = calMetadataB.getValue().get(tuple._1+"_"+"cal1");
//					Sentinel1Calibrator sentinel1Calibrator = new Sentinel1Calibrator(calMeatadata);
...
//
//				});
        //slave image calibration
//		JavaPairRDD<String, MyTile> slaveRastersCal = slaveRastersRdd.mapToPair((Tuple2<String, Point> tuple) -> {
//			Map<String, ImageMetadata> map = imgMetadataB.getValue();
//			ImageMetadata srcImgMetadataCal2 = map.get(tuple._1+"_"+"cal2");
//			ImageMetadata trgImgMetadataCal2 = map
//					.get(srcImgMetadataCal2.getBandPairName()+"_"+"cal2");
//			
//			ImageMetadata imgMetadataRead = map.get(srcImgMetadataCal2.getBandPairName()+"_"+"read2");
//			MyTile readTile=new MyTile(imgMetadataRead.getWritableRaster(tuple._2.x, tuple._2.y),
//					trgImgMetadataCal2.getRectangle(tuple._2.x, tuple._2.y),
//					trgImgMetadataCal2.getDataType());
//			ReadHDFSTile readHDFSTile=new ReadHDFSTile();
//			readTile=readHDFSTile.readTile(hdfsPathsB.getValue().get(1), readTile);
//			
//			Point targetPoint = tuple._2;
//			CalibrationMetadata calMeatadata = calMetadataB.getValue().get(tuple._1+"_"+"cal2");
//			Sentinel1Calibrator sentinel1Calibrator = new Sentinel1Calibrator(calMeatadata);
...
//		});
        ...
        long totalwithGCPTime = endWithGCPTime - startWithGCPTime;
...
//						ImageMetadata trgImgMetadata=imgMetadataB.getValue().get(pair._1._2);
...
//						}
//			
//						return new Tuple2<Tuple2<Point, String>, MyTile>(pair._1, targetTile);
//					});
