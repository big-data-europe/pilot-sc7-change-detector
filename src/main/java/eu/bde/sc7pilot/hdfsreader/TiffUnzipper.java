 ...
 * as argument. It unzips in the zip's directory and returns the
 * local-FS-filepath which: 1) is in the unzipped folder 2) is the
 * local-FS-filepath of the unzipped .tiff file!!!
 *
 * G.A. gioargyr@di.uoa.gr gioargyr@gmail.com
 */
