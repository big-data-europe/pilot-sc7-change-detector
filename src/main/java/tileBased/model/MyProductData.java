...
/**
 * The abstract <code>MyProductData</code> class represents a generic data buffer used to hold the actual data values
 * stored in remote sensing data products.
 * <p> A single <code>MyProductData</code> instance can have one or more elements of a primitive type. The primitive types
 * are:
 * <ul>
 * <li> {@link MyProductData.Byte signed 8-bit integer} </li>
 * <li> {@link MyProductData.UByte unsigned 16-bit integer} </li>
 * <li> {@link MyProductData.Short signed 32-bit integer} </li>
 * <li> {@link MyProductData.UShort unsigned 16-bit integer} </li>
 * <li> {@link MyProductData.Int signed 32-bit integer} </li>
 * <li> {@link MyProductData.UInt unsigned 32-bit integer} </li>
 * <li> {@link MyProductData.Float 32-bit floating point} </li>
 * <li> {@link MyProductData.Double 64-bit floating point} </li>
 * <li> {@link MyProductData.ASCII a character string (8-bit ASCII encoding)} </li>
 * <li> {@link MyProductData.UTC a MJD-2000 encoded data/time value} </li>
 * </ul>
 * <p>The number of elements is an inmutable property of a <code>MyProductData</code> instance.
 * <p>In order to access the data in a <code>MyProductData</code> instance, multiple setters and getters are provided
 * which use generic <i>transfer data types</i> in order to make the data transfer in and out of a
 * <code>MyProductData</code> instance easy for programmers.<br> For scalar (one-element) values the prototypes are
 * <pre>
 ...
 */
public abstract class MyProductData implements Cloneable,Serializable {
     ...
     */
    protected MyProductData(int type) {
        _type = type;
    }
     ...
     */
    public static MyProductData createInstance(int type) {
     ...
     *
     * @param type     the value's type
     * @param numElems the number of elements, must be greater than zero if type is not {@link MyProductData#TYPE_UTC}
     *
     * @return a new value instance, <code>null</code> if the given type is not known
     *
     ...
     * @throws IllegalArgumentException if one of the arguments is invalid
     */
    public static MyProductData createInstance(int type, Object data) {
        switch (type) {
            case TYPE_INT8:
                return new MyProductData.Byte((byte[]) data);
            case TYPE_INT16:
                return new MyProductData.Short((short[]) data);
            case TYPE_INT32:
                return new MyProductData.Int((int[]) data);
            case TYPE_UINT8:
                return new MyProductData.UByte((byte[]) data);
            case TYPE_UINT16:
                return new MyProductData.UShort((short[]) data);
            case TYPE_UINT32:
                return new MyProductData.UInt((int[]) data);
            case TYPE_FLOAT32:
                return new MyProductData.Float((float[]) data);
            case TYPE_FLOAT64:
                return new MyProductData.Double((double[]) data);
            case TYPE_ASCII:
                return new MyProductData.ASCII(data.toString());
            case TYPE_UTC:
                return new MyProductData.UTC((int[]) data);
            default:
                return null;
        }
    }

    public static MyProductData createInstance(byte[] elems) {
        Guardian.assertNotNull("elems", elems);
        return new MyProductData.Byte(elems);
    }

    public static MyProductData createUnsignedInstance(byte[] elems) {
        Guardian.assertNotNull("elems", elems);
        return new MyProductData.UByte(elems);
    }

    public static MyProductData createInstance(short[] elems) {
        Guardian.assertNotNull("elems", elems);
        return new MyProductData.Short(elems);
    }

    public static MyProductData createUnsignedInstance(short[] elems) {
        Guardian.assertNotNull("elems", elems);
        return new MyProductData.UShort(elems);
    }

    public static MyProductData createInstance(int[] elems) {
        Guardian.assertNotNull("elems", elems);
        return new MyProductData.Int(elems);
    }

    public static MyProductData createUnsignedInstance(int[] elems) {
        Guardian.assertNotNull("elems", elems);
        return new MyProductData.UInt(elems);
    }

    @Deprecated
    public static MyProductData createInstance(long[] elems) {
        Guardian.assertNotNull("elems", elems);
        return new MyProductData.UInt(elems);
    }

    public static MyProductData createInstance(String strData) {
        Guardian.assertNotNull("strData", strData);
        return new MyProductData.ASCII(strData);
    }

    public static MyProductData createInstance(float[] elems) {
        Guardian.assertNotNull("elems", elems);
        return new MyProductData.Float(elems);
    }

    public static MyProductData createInstance(double[] elems) {
        Guardian.assertNotNull("elems", elems);
        return new MyProductData.Double(elems);
    }
...
//    }
    ...
    /**
     * Reads all elements of this <code>MyProductData</code> instance from to the given input stream.
     * <p> The method subsequentially reads the elements at <code>0</code> to <code>getNumElems()-1</code> of this
     * <code>MyProductData</code> instance from the given input stream.<br> Reading starts at the current seek position
    ...
    /**
     * Reads a single element of this <code>MyProductData</code> instance from to the given output stream.
     * <p> The method reads the element at <code>pos</code> of this <code>MyProductData</code> instance from the given
    ...
    /**
     * Reads elements of this <code>MyProductData</code> instance from the given output stream.
     * <p> The method subsequentially reads the elements at <code>startPos</code> to <code>startPos+numElems-1</code> of
     * this <code>MyProductData</code> instance from the given input stream.<br> Reading starts at the current seek
    ...
    /**
     * Reads elements into this <code>MyProductData</code> instance from the given input stream.
     * <p> The method subsequentially reads the elements at <code>startPos</code> to <code>startPos+numElems-1</code> of
     * this <code>MyProductData</code> instance from the given input stream.<br> Reading starts at <code>inputPos</code>
    ...
    /**
     * Writes all elements of this <code>MyProductData</code> instance to to the given output stream.
     * <p> The method subsequentially writes the elements at <code>0</code> to <code>getNumElems()-1</code> of this
     * <code>MyProductData</code> instance to the given output stream.<br> Writing starts at the current seek position
    ...
    /**
     * Writes a single element of this <code>MyProductData</code> instance to to the given output stream.
     * <p> The method writes the element at <code>pos</code> of this <code>MyProductData</code> instance to the given
    ...
    /**
     * Writes elements of this <code>MyProductData</code> instance to to the given output stream.
     * <p> The method subsequentially writes the elements at <code>startPos</code> to <code>startPos+numElems-1</code>
     * of this <code>MyProductData</code> instance to the given output stream.<br> Writing starts at the current seek
     ...
     * Writes elements of this <code>MyProductData</code> instance to to the given output stream.
     * <p> The method subsequentially writes the elements at <code>startPos</code> to <code>startPos+numElems-1</code>
     * of this <code>MyProductData</code> instance to the given output stream.<br> Writing starts at
    ...
    /**
     * Tests whether this MyProductData is equal to another one.
     * Performs an element-wise comparision if the other object is a {@link MyProductData} instance of the same data type.
     * Otherwise the method behaves like {@link Object#equals(Object)}.
     *
     * @param other the other one
     */
    public boolean equalElems(MyProductData other) {
     ...
     */
    protected abstract MyProductData createDeepClone();
    ...
    /**
     * The <code>Byte</code> class is a <code>MyProductData</code> specialisation for signed 8-bit integer fields.
     * <p> Internally, data is stored in an array of the type <code>byte[]</code>.
     */
    public static class Byte extends MyProductData {
         ...
         */
        @Override
        protected MyProductData createDeepClone() {
        ...
        /**
         * Please refer to {@link MyProductData#getElemIntAt(int)}.
         */
        @Override
        ...
        /**
         * Please refer to {@link MyProductData#getElemUIntAt(int)}.
         */
        @Override
        ...
        /**
         * Please refer to {@link MyProductData#getElemFloatAt(int)}.
         */
        @Override
        ...
        /**
         * Please refer to {@link MyProductData#getElemDoubleAt(int)}.
         */
        @Override
        ...
        /**
         * Please refer to {@link MyProductData#getElemStringAt(int)}.
         */
        @Override
        ...
        /**
         * Please refer to {@link MyProductData#setElemIntAt(int, int)}.
         */
        @Override
        ...
        /**
         * Please refer to {@link MyProductData#setElemUIntAt(int, long)}.
         */
        @Override
        ...
        /**
         * Please refer to {@link MyProductData#setElemFloatAt(int, float)}.
         */
        @Override
        ...
        /**
         * Please refer to {@link MyProductData#setElemDoubleAt(int, double)}.
         */
        @Override
        ...
        /**
         * Please refer to {@link MyProductData#readFrom(int, int, ImageInputStream)}.
         */
        @Override
        ...
        /**
         * Please refer to {@link MyProductData#writeTo(int, int, ImageOutputStream)}.
         */
        @Override
    ...
    /**
     * The <code>UByte</code> class is a <code>MyProductData</code> specialisation for unsigned 8-bit integer fields.
     * <p> Internally, data is stored in an array of the type <code>byte[]</code>.
    ...
    /**
     * The <code>Short</code> class is a <code>MyProductData</code> specialisation for signed 16-bit integer fields.
     * <p> Internally, data is stored in an array of the type <code>short[]</code>.
     */
    public static class Short extends MyProductData {
    ...
    /**
     * The <code>UShort</code> class is a <code>MyProductData</code> specialisation for unsigned 16-bit integer fields.
     * <p> Internally, data is stored in an array of the type <code>short[]</code>.
     * <p> In order to preserve the accuracy for the unsigned byte value range the <code>getElemIntAt</code> method
     * should be used to retrieve the data stored in this value instead of accessing the data array directly.
     * <p>
    ...
    /**
     * The <code>Int</code> class is a <code>MyProductData</code> specialisation for signed 32-bit integer fields.
     * <p> Internally, data is stored in an array of the type <code>int[]</code>.
     */
    public static class Int extends MyProductData {
    ...
    /**
     * The <code>UInt</code> class is a <code>MyProductData</code> specialisation for unsigned 32-bit integer fields.
     * <p> Internally, data is stored in an array of the type <code>int[]</code>.
    ...
    /**
     * The <code>MyProductData.Float</code> class is a <code>MyProductData</code> specialisation for 32-bit floating point
     * fields.
     * <p> Internally, data is stored in an array of the type <code>float[]</code>.
     */
    public static class Float extends MyProductData {
        ...
        public boolean equalElems(MyProductData other) {
            if (other == this) {
                return true;
            } else if (other instanceof MyProductData.Float) {
                return Arrays.equals(_array, ((MyProductData.Float) other).getArray());
            }
            return false;
        }
    ...
    /**
     * The <code>MyProductData.Float</code> class is a <code>MyProductData</code> specialisation for 64-bit floating point
     * fields.
     * <p> Internally, data is stored in an array of the type <code>double[]</code>.
     */
    public static class Double extends MyProductData {
    ...
    /**
     * The <code>MyProductData.ASCII</code> class is a <code>MyProductData.Byte</code> specialisation representing textual
     * values.
     * <p> Internally, data is stored in an array of the type <code>byte[]</code>.
     */
    ...
    /**
     * The <code>MyProductData.UTC</code> class is a <code>MyProductData.UInt</code> specialisation for UTC date/time
     * values.
     * <p> Internally, data is stored in an <code>int[3]</code> array which represents a Modified Julian Day 2000
     * ({@link MyProductData.UTC#getMJD() MJD}) as a {@link
     * MyProductData.UTC#getDaysFraction() days}, a {@link
     * MyProductData.UTC#getSecondsFraction() seconds} and a {@link
     * MyProductData.UTC#getMicroSecondsFraction() micro-seconds} fraction.
     *
     * @see MyProductData.UTC#getMJD()
     * @see MyProductData.UTC#getDaysFraction()
     * @see MyProductData.UTC#getSecondsFraction()
     * @see MyProductData.UTC#getMicroSecondsFraction()
     */
