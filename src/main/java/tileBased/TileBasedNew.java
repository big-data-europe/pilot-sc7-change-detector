...
public class TileBasedNew {
	...
	public void processTiles(File masterFile, File slaveFile) throws Exception {
		...
		//if you set polarizations !=null, from the multi band images, only the bands corresponding to the selected polarizations will be processed.
...
//		String[] selectedPolarisations={"VV"};
		...
		String filesPath = "/home/ethanos/Desktop/BDEimages";
		File targetFile = new File(filesPath, "/VH/changeD3-sparkVV");
