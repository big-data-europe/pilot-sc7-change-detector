...
public class CalibrationMappers {
	...
	public static List<Tuple2<Tuple2<Point, String>, MyTile>> calibrationMasterFromHdfs(Iterator<Tuple2<String, Point>> iterator,
	...
	public static List<Tuple2<String,  MyTile>> calibrationSlaveFromHdfs(Iterator<Tuple2<String, Point>> iterator,
			Map<String, BandInfo> infos, Map<String, ImageMetadata> map,
			Map<String, CalibrationMetadata> calMetadataMap) {
	...
	public static Tuple2<String, MyTile> calibrationSlave(Tuple2<String, MyTile> tuple,Map<String, ImageMetadata> map,
			Map<String, CalibrationMetadata> calMetadataMap) {
	...
	public static Tuple2<Tuple2<Point, String>, MyTile> calibrationMaster(Tuple2<String, MyTile> tuple,Map<String, ImageMetadata> map,
			Map<String, CalibrationMetadata> calMetadataMap) {
